                ...
                <div className='flex flex-col mt-10'>
                    {
                        theatre && theatre.map((theatre) => {
                            return (
                                <>
                                    <div className='flex flex-col gap-5 border border-gray-400 rounded-md p-5 shadow-sm'>
                                        ...
                                        <div className='flex gap-4'>
                                            {
                                                theatre.shows.sort((a, b) => moment(a.show_time, "HH:mm") - moment(b.show_time, "HH:mm")).map((show) => {
                                                    return (
                                                        <div className='border-2 border-yellow-400 p-3 hover:bg-yellow-400 hover:cursor-pointer transition-all'
